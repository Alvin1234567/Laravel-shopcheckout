...
function LoginCtrl($http, $scope, $timeout, $state, $location, sessionSvc){
    ...
    this.tryLogin = function(){
        ...
        var req = {
            method: 'POST',
            url: 'api/auth/CustomerAuthenticate',
            data: data,
            headers : {'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8'}
        };
...
function AccountCtrl($http, $state, $location, $scope, dataTableSvc, sessionSvc){
     ...
     * 
     */
    $scope.getFruitData = function(){
        var params = {
            src: $scope.src,
            user_action: "getFruitData",
        ...
        $http(req).then(function(data){
            if(data.data.restricted){
                ...
                dataTableSvc.FruitTableInit(FruitsTable, data.data);
            }           
        });
    ...
    $scope.contractsInit = function(){
        ...
        var req = {
            method: 'GET',
            url: 'api/accounts/super-jackpot-lottery',
            params: params,
            headers : {'Content-Type':'application/json; charset=UTF-8'}
        };
